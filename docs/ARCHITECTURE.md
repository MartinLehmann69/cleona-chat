...
<!-- AUTO-GENERATED from Cleona_Chat_Architecture_v3_0.md (sha256:a4cb27d61861, 2026-07-28). -->
...
4. Receiver node reads the manifest (existing 6h poller), detects new version. The update banner appears: "Update verfügbar: vX.Y.Z" with a **Download** button and a dismiss button (session-scoped).
