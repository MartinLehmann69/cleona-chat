...
class AuthManifestProto extends $pb.GeneratedMessage {
  factory AuthManifestProto({
    ...
    $core.Iterable<DeviceDelegationCertProto>? deviceDelegations,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AuthManifestProto', package: const $pb.PackageName(_omitMessageNames ? '' : 'cleona'), createEmptyInstance: create)
    ...
    ..pc<DeviceDelegationCertProto>(11, _omitFieldNames ? '' : 'deviceDelegations', $pb.PbFieldType.PM, subBuilder: DeviceDelegationCertProto.create)
    ..pc<AuthorizedDeviceSigningKeys>(12, _omitFieldNames ? '' : 'deviceSigKeys', $pb.PbFieldType.PM, subBuilder: AuthorizedDeviceSigningKeys.create)
    ..aOM<DeviceSetChangeProof>(13, _omitFieldNames ? '' : 'deviceSetChangeProof', subBuilder: DeviceSetChangeProof.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(11)
  $core.List<DeviceDelegationCertProto> get deviceDelegations => $_getList(10);
  ...
  @$pb.TagNumber(12)
  $core.List<AuthorizedDeviceSigningKeys> get deviceSigKeys => $_getList(11);

  /// §7.5: Proof that device-set shrinks were co-authorized by remaining devices.
  @$pb.TagNumber(13)
  DeviceSetChangeProof get deviceSetChangeProof => $_getN(12);
  @$pb.TagNumber(13)
  set deviceSetChangeProof(DeviceSetChangeProof v) { setField(13, v); }
  @$pb.TagNumber(13)
  $core.bool hasDeviceSetChangeProof() => $_has(12);
  @$pb.TagNumber(13)
  void clearDeviceSetChangeProof() => clearField(13);
  @$pb.TagNumber(13)
  DeviceSetChangeProof ensureDeviceSetChangeProof() => $_ensure(12);
}
...
class ApplicationFrameV3 extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(18)
  $fixnum.Int64 get groupMembershipEpoch => $_getI64(15);
  @$pb.TagNumber(18)
  set groupMembershipEpoch($fixnum.Int64 v) { $_setInt64(15, v); }
  @$pb.TagNumber(18)
  $core.bool hasGroupMembershipEpoch() => $_has(15);
  @$pb.TagNumber(18)
  void clearGroupMembershipEpoch() => clearField(18);

  @$pb.TagNumber(19)
  $core.List<$core.int> get groupMembershipHash => $_getN(16);
  @$pb.TagNumber(19)
  set groupMembershipHash($core.List<$core.int> v) { $_setBytes(16, v); }
  @$pb.TagNumber(19)
  $core.bool hasGroupMembershipHash() => $_has(16);
  @$pb.TagNumber(19)
