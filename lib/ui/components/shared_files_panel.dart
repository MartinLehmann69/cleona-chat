...
// as long as §17.5's group topology is open, C-9/C-10/C-11). A
// download button here would additionally be a second, separate promise: even
// with a carrier `CallFileShare` (proto/app_payloads.proto) transports
// only the announcement (name/size/mime), no data field — the
// actual byte transfer is built nowhere.
